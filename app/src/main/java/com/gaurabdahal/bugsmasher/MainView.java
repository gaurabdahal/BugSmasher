...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        Assets.sound_squish[0] = Assets.soundPool.load(context, R.raw.squish1, 1);
        Assets.sound_squish[1] = Assets.soundPool.load(context, R.raw.squish2, 1);
        Assets.sound_squish[2] = Assets.soundPool.load(context, R.raw.squish3, 1);
        Assets.sound_squish[3] = Assets.soundPool.load(context, R.raw.bigsquish, 1);
        Assets.sound_thump = Assets.soundPool.load(context, R.raw.thump, 1);
        Assets.sound_clap = Assets.soundPool.load(context, R.raw.clap, 1);
